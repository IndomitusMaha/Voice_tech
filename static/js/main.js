...
function stopRecording() {
    ...
    sendRecordingToServer(rec.exportWAV());
}
...
function sendRecordingToServer(recordedBlob) {
    ...
    let fd = new FormData();
    fd.append('voice_request', recordedBlob);
...
function createDownloadLink(blob) {
    ...
    upload.addEventListener("click", function(event) {
        ...
        var fd = new FormData();
        fd.append("demoasr_result", blob, "voice_recording.wav");
        xhr.open("POST", "/demoasr_result", true);
        xhr.send(fd);
    })
